...
const QuotationPage = () => {
  ...
  const [header, setHeader] = useState({
    ...
    hsnCode: '', panNo: '',
    quotationNo: '', quotationDate: new Date().toISOString().slice(0, 10), inquiryNo: inq?.inquiryNo || '',
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      pdf.save(`Quotation-${header.quotationNo || 'draft'}.pdf`);
    } catch { /* silent */ }
  ...
  return (
    <div className="quot-page">
      <div className="quot-topbar">
        ...
        <h2 className="quot-title">Quotation</h2>
      </div>
      ...
      <div className="quot-preview" ref={pdfRef}>
        ...
        {/* Header */}
        <div className="quot-doc-title">QUOTATION</div>

        <div className="quot-header-grid">
          <div className="quot-col">
            <div className="quot-field">
              <label>Company Name</label>
              <input name="companyName" value={header.companyName} onChange={handleHeader} placeholder="Enter company name" />
            </div>
            <div className="quot-field">
              <label>Company Address</label>
              <input name="companyAddress" value={header.companyAddress} onChange={handleHeader} placeholder="Enter address" />
            </div>
            <div className="quot-field">
              <label>Company Email</label>
              <input name="companyEmail" value={header.companyEmail} onChange={handleHeader} placeholder="Enter email" />
            </div>
            <div className="quot-field">
              <label>Kind Attention</label>
              <input name="kindAttention" value={header.kindAttention} onChange={handleHeader} placeholder="Enter contact person" />
            </div>
            <div className="quot-field">
              <label>MSME No</label>
              <input name="msmeNo" value={header.msmeNo} onChange={handleHeader} placeholder="Enter MSME number" />
            </div>
            <div className="quot-field">
              <label>Provisional GST No</label>
              <input name="provisionalGstNo" value={header.provisionalGstNo} onChange={handleHeader} placeholder="Enter GST number" />
            </div>
            <div className="quot-field">
              <label>HSN Code</label>
              <input name="hsnCode" value={header.hsnCode} onChange={handleHeader} placeholder="Enter HSN code" />
            </div>
            <div className="quot-field">
              <label>PAN No</label>
              <input name="panNo" value={header.panNo} onChange={handleHeader} placeholder="Enter PAN number" />
            </div>
          </div>
          ...
          <div className="quot-col">
            <div className="quot-field">
              ...
              <input name="quotationNo" value={header.quotationNo} onChange={handleHeader} placeholder="e.g. QT-001" />
            </div>
            <div className="quot-field">
              <label>Quotation Date</label>
              <input name="quotationDate" type="date" value={header.quotationDate} onChange={handleHeader} />
            </div>
            <div className="quot-field">
              <label>Inquiry No</label>
              <input name="inquiryNo" value={header.inquiryNo} onChange={handleHeader} placeholder="e.g. INQ-001" />
            </div>
            <div className="quot-field">
              <label>Inquiry Date</label>
              <input name="inquiryDate" type="date" value={header.inquiryDate} onChange={handleHeader} />
            </div>
            <div className="quot-field">
              <label>Inquiry Due Date</label>
              <input name="inquiryDueDate" type="date" value={header.inquiryDueDate} onChange={handleHeader} />
            </div>
          </div>
        </div>
      ...
      <div className="quot-bottom-bar">
        <button className="quot-pdf-btn" onClick={generatePDF} disabled={generating}>
